      ...
      <div className="flex-1 p-6 flex flex-col">
        ...
        {loading && (
          <div className="flex-1 flex flex-col items-center justify-center text-center py-16">
            ...
            <p className="text-base font-black text-navy-700">Claude is writing your copy...</p>
            <p className="text-xs text-gray-400 mt-1 mb-5">Analyzing your GIA data - this takes about 5 seconds</p>
